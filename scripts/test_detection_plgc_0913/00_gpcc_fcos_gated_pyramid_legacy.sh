#!/bin/bash
# GPCC 0913 E00: fcos + gated_pyramid + legacy head.
set -euo pipefail
cd "$(dirname "$0")/../.."
...
SAVE_DIR="records/test_detection_plgc_0913/GPCC-E00_${DATASET_INFO}-direct-tok${PATCH_SIZE}-sp${SPECTRAL_PATCH_SIZE}_fcos-gated_pyramid-legacy_seed${SEED}_${EXP_TIME}"
mkdir -p "$SAVE_DIR"

#!/bin/bash
# GPCC 0913 E06: retinanet + gated_fpn + legacy head.
set -euo pipefail
cd "$(dirname "$0")/../.."
...
SAVE_DIR="records/test_detection_plgc_0913/GPCC-E06_${DATASET_INFO}-direct-tok${PATCH_SIZE}-sp${SPECTRAL_PATCH_SIZE}_retinanet-gated_fpn-legacy_seed${SEED}_${EXP_TIME}"
mkdir -p "$SAVE_DIR"

#!/bin/bash
# GPCC 0913 E03: fcos + gated_fpn + GroupNorm + IoU quality.
set -euo pipefail
cd "$(dirname "$0")/../.."
...
SAVE_DIR="records/test_detection_plgc_0913/GPCC-E03_${DATASET_INFO}-direct-tok${PATCH_SIZE}-sp${SPECTRAL_PATCH_SIZE}_fcos-gated_fpn-gn_quality_seed${SEED}_${EXP_TIME}"
mkdir -p "$SAVE_DIR"

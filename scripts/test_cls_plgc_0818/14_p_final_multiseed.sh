#!/bin/bash
# P-Final: selected PLGC configuration repeated with at least three random seeds.
...
DATA_VARIANT="mse015"  # unfiltered | mse015
HARD_CASE_LEVEL="${SELECTED_HARD_CASE_LEVEL:-H2}"  # H0 | H1 | H2 | H3
AUGMENT="true"
AUGMENTATION_COPIES="${SELECTED_AUGMENTATION_COPIES:-2}"
BALANCE_MODE="${SELECTED_BALANCE_MODE:-balanced_sampling}"  # none | balanced_sampling | inverse_freq_loss
CLASSIFICATION_HEAD="${BEST_CLASSIFICATION_HEAD:-h2_dual_scale}"

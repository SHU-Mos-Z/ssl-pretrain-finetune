...
# Experiment P-E1: use one endmember matrix per original PUAD scene.
# Generate this cache first with scripts/run_offline_nmf_puad_scene_endmembers.sh.
EXPERIMENT_ID="P-E1"
AUGMENT="true"
AUGMENTATION_COPIES="1"
AUGMENTATION_POLICY="${BEST_AUGMENTATION_POLICY:-dihedral}"
SEGMENTATION_HEAD="${SCREEN_SEGMENTATION_HEAD:-h0_simple}"
SEGMENTATION_LOSS="${SCREEN_SEGMENTATION_LOSS:-ce_dice}"
ENDMEMBER_SCOPE="scene"
SCENE_ENDMEMBER_ROOT="${SCENE_ENDMEMBER_ROOT:-/home/zsq/processed_data/DFS3R-main/data/LUAD_PUAD_official224_bgaware_fg3138_bg1569_fullsceneval/scene_endmembers_K16_l10.0005_l20.0002_l30.01_le0.05_ec3_simplex}"
...
# MDC（分割）
# TRAIN_ROOT="data/MDC_Resized_256_320_to_256_256_overlap_0_0_preprocessed_finetune_train_p049_20260728"
# VAL_ROOT="data/MDC_Resized_256_320_to_256_256_overlap_0_0_preprocessed_finetune_val_p010_20260728"
# TEST_ROOT="data/MDC_Resized_256_320_to_256_256_overlap_0_0_preprocessed_finetune_test_p010_20260728"

# GPCC（分割）
# TRAIN_ROOT="data/GPCC_Resized_512_640_to_256_256_overlap_0_0_preprocessed_finetune_train_p070_20260728"
# VAL_ROOT="data/GPCC_Resized_512_640_to_256_256_overlap_0_0_preprocessed_finetune_val_p015_20260728"
...
# VAL_ROOT="data/TMA_patch_1024x1024_overlap_0x0_to_256x256_minmax_finetune_val_p015_20260728"
# TEST_ROOT="data/TMA_patch_1024x1024_overlap_0x0_to_256x256_minmax_finetune_test_p015_20260728"
...
NMF_LAM_E=0.05
NMF_E_CLAMP_MAX=3.0
ALLOW_INDEX_WAVELENGTHS=false
WAVELENGTH_FILE=""          # 真实波长表 .npy；留空时按 ALLOW_INDEX_WAVELENGTHS 回退
...
SCENE_VAL_WINDOW_BLEND="${SCENE_VAL_WINDOW_BLEND:-gaussian}"
# 测试推理：direct 适合已切好的整齐 patch；sliding_window 用于 PUAD 全图。
# TEST_WINDOW_SIZE 是空间推理窗口，不是上面的模型 Token PATCH_SIZE。
TEST_INFERENCE_MODE="${TEST_INFERENCE_MODE:-sliding_window}"
TEST_WINDOW_SIZE="${TEST_WINDOW_SIZE:-224}"
TEST_WINDOW_STRIDE="${TEST_WINDOW_STRIDE:-112}"
...
SAVE_DIR="${SAVE_DIR:-./records/test_seg_puad_0914/${EXPERIMENT_ID}_${DATASET_INFO}${LOSS_MODE_SUFFIX}_${EXP_TIME}}"
mkdir -p "$SAVE_DIR"

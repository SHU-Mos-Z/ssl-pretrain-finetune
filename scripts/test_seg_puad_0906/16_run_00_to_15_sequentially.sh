...
# 2026-09-11 audit: P-00/P-A1/P-A2/P-A3/P-H1/P-H2/P-H3/P-L1/P-L2/
# P-L3/P-O1 already have complete test_metrics.json records.  P-O2 has only
# an interrupted partial run, so keep it together with the configurations that
# have not yet produced a complete test result.
EXPERIMENT_SCRIPTS=(

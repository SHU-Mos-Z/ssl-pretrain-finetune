...
# Experiment P-L3: weighted CE/Dice plus differentiable boundary Dice.
EXPERIMENT_ID="P-L3"
AUGMENT="true"
...
SEGMENTATION_LOSS="weighted_ce_dice_boundary"
CLASS_WEIGHT_MODE="inverse_sqrt"
BOUNDARY_LOSS_WEIGHT="${BOUNDARY_LOSS_WEIGHT:-0.2}"

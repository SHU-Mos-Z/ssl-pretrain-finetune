...
# TMA fixed splits (all inputs are 256x256 patches)
TRAIN_ROOT="${TRAIN_ROOT:-data/TMA_patch_1024x1024_overlap_0x0_to_256x256_minmax_finetune_train_p070_20260910}"
VAL_ROOT="${VAL_ROOT:-data/TMA_patch_1024x1024_overlap_0x0_to_256x256_minmax_finetune_val_p015_20260910}"
TEST_ROOT="${TEST_ROOT:-data/TMA_patch_1024x1024_overlap_0x0_to_256x256_minmax_finetune_test_p015_20260910}"

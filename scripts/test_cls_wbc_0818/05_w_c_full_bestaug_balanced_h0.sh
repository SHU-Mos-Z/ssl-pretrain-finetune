#!/bin/bash
# W-C: selected augmentation count, true balanced sampling, H0.
...
DATA_VARIANT="new"
AUGMENT="true"
BEST_AUGMENTATION_COPIES="${BEST_AUGMENTATION_COPIES:-2}"
AUGMENTATION_COPIES="$BEST_AUGMENTATION_COPIES"
BALANCE_MODE="balanced_sampling"

#!/bin/bash
# W-History: historical split-patch data and original H0 settings.
...
TRAIN_ROOT="${TRAIN_ROOT:-data/2018WBC_patch_650x600_overlap_0x0_to_256x256_minmax_bands50_finetune_train_p049_20260728}"
VAL_ROOT="${VAL_ROOT:-data/2018WBC_patch_650x600_overlap_0x0_to_256x256_minmax_bands50_finetune_val_p011_20260728}"
TEST_ROOT="${TEST_ROOT:-data/2018WBC_patch_650x600_overlap_0x0_to_256x256_minmax_bands50_finetune_test_p011_20260728}"
